                ...
                <div className={manageStyles.card}>
                    <div className={manageStyles.cardHeader}>
                        ...
                        <div className={manageStyles.exportButtons}>
                            {isAdmin && (<button onClick={handleDownloadZip} disabled={isZipping} className={manageStyles.actionButton}>{isZipping ? 'Generating...' : <><FiZap/> Download All (ZIP)</>}</button>)}
                            <button onClick={downloadStudentListPDF} className={manageStyles.actionButton}><FiFileText/> Export List (PDF)</button>
                            <button onClick={downloadStudentListExcel} disabled={!scriptsLoaded} className={manageStyles.actionButton}><FiGrid/> Export List (Excel)</button>
                        </div>
                    </div>
                    ...
                    <div className={manageStyles.tableWrapper}>
                        {/* ⚠️ এখানে manageStyles.resultsTable ক্লাসটি পরিবর্তন করে manageStyles.table করা হয়েছে ⚠️ */}
